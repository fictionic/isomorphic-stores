...
import { definePage, type PageInit } from '../core/common/handler/Page';
import { defineEndpoint, type EndpointInit } from '../core/common/handler/Endpoint';
import { setCookie } from '../core/common/cookies';
