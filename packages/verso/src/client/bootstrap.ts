...
import {type VersoRoutes} from '../core/router';
import {ClientController} from './controller';

export type PageLoaders = Record<string, () => Promise<{ default: PageDefinition }>>;

export async function bootstrap(site: VersoRoutes, pageLoaders: PageLoaders, manifest: BundleManifest | null): Promise<void> {
